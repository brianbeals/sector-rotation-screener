...
*Generated by Claude ({CLAUDE_MODEL}) from the output of the open-source [sector-rotation-screener](../../README.md). Methodology, code, and license live in the same repository.*
"""
